...
public class Solution {
    public static void main(String[] args)
    {
        ...
        try
        {
            ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("d:\\file1.txt"));
            output.writeObject(person);
            output.close();

            ObjectInputStream input = new ObjectInputStream(new FileInputStream("d:\\file1.txt"));
