        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (name1.compareTo(name2) == 0) {
                    Date dt1 = (Date) stock1.get("date");
                    Date dt2 = (Date) stock2.get("date");
                    if (dt2.compareTo(dt1) == 0)
                    {
                        double pr1;
                        double pr2;
                        if (stock1.containsKey("change")) pr1 = (double) stock1.get("change");
                        else pr1 = (double) stock1.get("last") - (double) stock1.get("open");
                        if (stock2.containsKey("change")) pr2 = (double) stock2.get("change");
                        else pr2 = (double) stock2.get("last") - (double) stock2.get("open");
                        return Double.compare(pr2, pr1);
                    }
                    else return dt2.compareTo(dt1);
